...
const About = () => {
  return (
    <div className="min-h-screen dark:bg-[#121212] dark:text-white">
        ...
        <section className="py-8 bg-white text-center px-6 md:flex justify-around dark:bg-[#1A1A1A]">
...
<section className="py-16 dark:bg-[#121212]">
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="flex flex-col md:flex-row gap-10 md:justify-around md:gap-14">
      ...
      {/* Feature 1 */}
      <div className="w-full md:w-80 lg:w-96 dark:from-[#1E58C8] dark:to-[#3A77E5]  bg-gradient-to-r from-amber-50  to-indigo-100 rounded-lg shadow-xl overflow-hidden transform transition-transform duration-500 hover:-translate-y-5 hover:shadow-2xl hover:bg-gradient-to-r hover:from-amber-100 hover:to-indigo-200">
