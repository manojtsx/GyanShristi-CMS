...
const About = () => {
  return (
    <div className="min-h-screen dark:bg-gray-900 dark:text-white">
        ...
        <section className="py-8 bg-white text-center px-6 md:flex justify-around">
          {/* <div className="max-w-3xl mx-auto flex"> */}
          <div className='flex flex-col px-1 items-center justify-center mb-5 md:w-96 md:gap-1'>
            <h2 className="text-2xl font-bold text-[#3D52A0] pb-1 md:text-3xl">About Gyanshristi</h2>
            <p className=" text-xs text-center md:text-sm md:mb-6">
...
<section className="py-16">
  <div className="max-w-6xl mx-auto px-6">
    <h2 className="text-2xl md:text-3xl font-bold text-[#3D52A0] text-center mb-12">Key Features</h2>
    <div className="flex flex-col md:flex-row gap-10 md:justify-around md:gap-14">

      {/* Feature 1 */}
      <div className="w-full md:w-80 lg:w-96 bg-gradient-to-r from-amber-50  to-indigo-100 rounded-lg shadow-xl overflow-hidden transform transition-transform duration-500 hover:-translate-y-5 hover:shadow-2xl hover:bg-gradient-to-r hover:from-amber-100 hover:to-indigo-200">
      ...
      <div className="w-full md:w-80 lg:w-96 bg-gradient-to-r from-amber-50  to-indigo-100 rounded-lg shadow-xl overflow-hidden transform transition-transform duration-500 hover:-translate-y-5 hover:shadow-2xl hover:bg-gradient-to-r hover:from-amber-100 hover:to-indigo-200">
        ...
        <section className="py-12  text-center px-6 bg-[#1E58C8]">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-12">Why Choose Gyanshristi?</h2>
            <div className="grid md:gap-6 gap-10 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-lg text-[#ececee] font-semibold md:mb-2">Innovation</h3>
                <p className="text-sm text-[#ececee] text-center">
              ...
              <div className='w-36 h-36 overflow-hidden rounded-full mb-1'>
                ...
                <h3 className="text-lg text-[#ececee] font-semibold md:mb-2">User-Friendly</h3>
                <p className="text-sm text-[#ececee] text-center">
              ...
              <div className='w-36 h-36 overflow-hidden rounded-full mb-1'>
                ...
                <h3 className="text-lg text-[#ececee] font-semibold md:mb-2">Accessibility</h3>
                <p className="text-sm text-[#ececee] text-center">
              ...
              <div className='w-36 h-36 overflow-hidden rounded-full mb-1'>
                ...
                <h3 className="text-lg text-[#ececee] font-semibold md:mb-2">Global Reach</h3>
                <p className="text-sm text-[#ececee] text-center">
        ...
        <section className="py-12 text-center px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#3570E2] mb-4">Our Commitment</h2>
