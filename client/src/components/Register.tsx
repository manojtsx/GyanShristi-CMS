    ...
    <main className=" flex flex-col md:flex-row min-h-screen dark:bg-[#121212] dark:text-white mt-10">
      ...
      <div className="flex justify-center items-center min-h-[90vh] w-full md:w-1/2 md:pl-24 mt-10 md:mt-0">
        {!showOtpContainer ? (
          ...
          />
          <button type="submit" className={`w-full px-4 py-2 ${isSubmitting ? 'bg-[#708ec9]' : 'bg-[#3570E2]'}} text-white rounded-md bg-blue-600 hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500`}
          disabled={isSubmitting}>
