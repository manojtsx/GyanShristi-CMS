    ...
    return (
        <div className="flex flex-col lg:flex-row mx-auto p-4 lg:py-8 lg:px-12">
            <div className="flex-1 lg:mr-8 mb-8 lg:mb-0">
                ...
                <img src={`${API}${thumbnail}`} alt="Thumbnail" className="w-full h-auto object-cover rounded-lg shadow-lg mb-4" />
      ...
      <p className='font-semibold text-black'>ABCD XYZ</p>
      </div> 
                    ...
                    <div className="flex items-center">
                        ...
                        <span className='text-xs'>{new Date(updated_at).toLocaleDateString()}</span>
                    </div>
                    </div>
                    <button className='px-4 py-2 rounded-md bg-[#3742FA] text-white'>Text to Speech</button>
                    </div>
                ...
                <div className="comment-section mx-auto mt-6 lg:mt-12">
                    ...
                    <div className="existing-comments space-y-6 lg:space-y-8">
                        <div className="comment bg-gray-50 shadow-md rounded-lg p-4 lg:p-6">
                            <div className="comment-header flex flex-col sm:flex-row items-start sm:items-center mb-4">
                                ...
                                <div className="comment-date text-sm text-gray-500">2 days ago</div>
                            </div>
                            <p className="comment-body text-gray-700">
                                This is a very insightful article! Thank you for sharing your knowledge.
                            </p>
                            ...
                            {showReplyForm && (
                                <div className="reply-form bg-gray-50 shadow-md rounded-lg p-4 lg:p-6 mt-4">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Your Reply</h4>
                                    <form>
                                        <textarea
                                ...
                                <div className="replies mt-4 space-y-4">
                                    ...
                                    <div className="reply bg-gray-100 shadow-md rounded-lg p-4">
                                        <div className="reply-header flex items-center mb-2">
                                            ...
                                            <div className="reply-date text-xs text-gray-500">1 day ago</div>
                                        </div>
            ...
            <aside className="w-full lg:w-1/4 bg-gray-100 p-4 lg:p-6 rounded-lg shadow-md">
                <h2 className="text-lg lg:text-xl font-semibold text-gray-900 mb-4">Advertisement</h2>
